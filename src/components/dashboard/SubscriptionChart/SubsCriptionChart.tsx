...
const data = [
  { day: "Sat", newSubscribers: 3, cancellations: 1 },
  { day: "Sun", newSubscribers: 18, cancellations: 4 },
  { day: "Mon", newSubscribers: 16, cancellations: 2 },
  { day: "Tue", newSubscribers: 24, cancellations: 6 },
  { day: "Wed", newSubscribers: 7, cancellations: 3 },
  { day: "Thu", newSubscribers: 20, cancellations: 8 },
  { day: "Fri", newSubscribers: 21, cancellations: 5 },
];

// ✅ Custom LegendPayload type (Recharts no longer exports LegendPayload)
...
export default function SubscriptionChart() {
  return (
    <div className="bg-[#131824] rounded-lg p-4 border border-slate-800 w-[800px]">
